...
public class LocationGPSReading extends BasicLogReading implements Serializable 
{
	...
	public LocationGPSReading(Date timeStamp, Date locationRecordingTime, double latitude, double longitude)
	{
		super(timeStamp);
	...
	public LocationGPSReading parseObjFromString (String inputFromLogFile)
	{
		...
		LocationGPSReading glr = new LocationGPSReading(dateTime, getDateFromString(params[0]), Double.parseDouble(params[1]), Double.parseDouble(params[2]));
